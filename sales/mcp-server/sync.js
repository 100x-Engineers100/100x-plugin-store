// sync.js — uploads sales wiki/ markdown files to Cloudflare KV
// Run: node sync.js
// Requires: wrangler authenticated (npx wrangler login)
// After running: wrangler kv namespace create "SALES_WIKI" — update KV_NAMESPACE_ID below
...
const KV_NAMESPACE_ID = 'f1c8871bad4d4029a6897576cdf11c45';
